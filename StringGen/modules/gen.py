...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@PusuXMusic_Bot"))
        else:
            ...
            await client.join_chat("PusuXMusic_Bot")
    except KeyError:
        pass
    try:
